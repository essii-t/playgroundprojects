(function () {
  ...
  function renderMain() {
    ...
    document.getElementById('page-main').innerHTML = `
      ...
      <div class="hero-card" style="margin-bottom:20px; display:flex; gap:60px; flex-wrap:wrap;">
        <div>
        ...
        <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:14px;">
          <div style="display:flex; gap:12px;">
            ...
            <div>
              ...
              <div style="font-size:12.5px; color:var(--text-faint);">Target ${g.targetDate}</div>
            </div>
          </div>
  ...
  function wireModals() {
    ...
    document.getElementById('new-goal-btn').addEventListener('click', () => newGoalModal.classList.add('open'));
